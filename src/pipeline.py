...
Colab gốc:
  ...
  Cell 8            -> audit
import evaluation.audit as audit
import utils.config as config
import utils.splitting as splitting
import data.windowing as windowing
...
Chạy trực tiếp: `python pipeline.py`
(hoặc dùng `python train.py`).
"""
...
import utils.splitting as splitting
import data.windowing as windowing
from data.augmentation import create_class_weights
from data.prepare_data import prepare_all_data
from data.qmi import load_qmi_sessions, print_qmi_summary
from data.weda import load_weda_sessions, print_weda_distributions
from evaluation.evaluation import evaluate_float_model
...
from training.finetune_prep import build_finetune_dataset
from training.finetune_train import finetune_stage1, finetune_stage2
from models.model import build_model, compile_model
from utils.normalization import domain_weighted_mean_std, make_normalizer
from evaluation.threshold_selection import evaluate_with_selected_threshold, select_fall_threshold
...
def run_full_pipeline():
    ...
    # ---------------------------------------------------------------
    from training.train_pretrain import pretrain_on_weda
